...
@torch.no_grad()
def sample_dpm_2_ancestral(model, x, sigmas, extra_args=None, callback=None, disable=None, eta=1., s_noise=1., noise_sampler=None, guider=None, callback_fn=None):
...
class DPMSolver(nn.Module):
    ...
    def dpm_solver_fast(self, x, t_start, t_end, nfe, eta=0., s_noise=1., noise_sampler=None, guider=None, callback=None):
        noise_sampler = default_noise_sampler(x) if noise_sampler is None else noise_sampler
...
@torch.no_grad()
def sample_dpm_fast(model, x, sigma_min, sigma_max, n, extra_args=None, callback=None, disable=None, eta=0., s_noise=1, guider=None, callback_fn=None, noise_sampler=None):
    ...
    with tqdm(total=n, disable=disable) as pbar:
        ...
        return dpm_solver.dpm_solver_fast(x, dpm_solver.t(torch.tensor(sigma_max)), dpm_solver.t(torch.tensor(sigma_min)), n, eta, s_noise, noise_sampler, guider, callback_fn)
...
@torch.no_grad()
def sample_dpmpp_2s_ancestral(model, x, sigmas, extra_args=None, callback=None, disable=None, eta=1., s_noise=1., noise_sampler=None, guider=None, callback_fn=None):
